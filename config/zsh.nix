...

{
  ...
  in {
    ...
    in ''
      ...
      export ZSH_HIGHLIGHT_STYLES[dollar-double-quoted-argument]='fg=${toString theme.foreground-alt}'
      export ZSH_HIGHLIGHT_STYLES[back-quoted-argument]='fg=${toString theme.foreground-alt}'
    ...
    environment.etc.dircolors = {
      text = ''
        ...
        FIFO ${toANSI theme.socket} # pipe
        SOCK ${toANSI theme.socket};4 # socket
